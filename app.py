...
from PIL import Image
img = Image.open("Logo-jiit.png")
st.image(img,width=100)

st.title("Minor Project - Sudoku Image Solver")
...
st.text("1) OpenCV-Python       : For using image processing algorthims for Grid Extraction and Digits Extraction.")
st.text("2) Keras, Scikit-Learn : For implementing ML models for recognizing digits extracted from the image")  
st.text("3) We have also used Swig for creating Python bindings of C++ code for solving the puzzle recognized from the image.")  
